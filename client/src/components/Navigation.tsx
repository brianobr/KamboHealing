...
export default function Navigation() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 bg-warm-beige/95 backdrop-blur-sm shadow-lg z-50">
          ...
          <div className="hidden md:block">
            <div className="flex items-center space-x-8">
              <button 
                ...
                className="text-dark-olive hover:text-forest-green transition-colors"
              >
                Home
              </button>
              <button 
              ...
              <button 
                ...
                className="bg-forest-green text-white px-6 py-2 rounded-full hover:bg-earth-brown transition-colors"
              >
                Book Session
              </button>
            </div>
      ...
      {/* Mobile Menu */}
      {isMobileMenuOpen && (
        <div className="md:hidden bg-warm-beige border-t border-warm-tan">
